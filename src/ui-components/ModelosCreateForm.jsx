...
export default function ModelosCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setModelurl(initialValues.Modelurl);
    setErrors({});
  };
  const validations = {
    Modelurl: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Modelos(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ModelosCreateForm")}
      {...rest}
    >
      <TextField
        label="Modelurl"
