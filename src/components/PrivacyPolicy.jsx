...
import NadvarModelos from './NadvarModelos';
        ...
        <Box my={4}>
          ...
          <Paper sx={{ padding: '20px', marginTop: '20px' }} elevation={3}>
            <Typography variant="body1" paragraph align="justify">
              El sitio web <strong>Color de tu esencia</strong> es propiedad de <strong>Xonix Technology</strong>, que es un controlador de datos de tus datos personales.
            </Typography>
            <Typography variant="body1" paragraph align="justify">
            Hemos adoptado esta Política de Privacidad, que determina cómo procesamos la información recopilada por Color de tu esencia, que también proporciona las razones por las que debemos recopilar ciertos datos personales sobre ti. Por lo tanto, debes leer esta Política de Privacidad antes de usar el sitio web de Color de tu esencia.
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            ...
            <ul>
              <Typography component="li" variant="body1">El derecho a ser informado.</Typography>
              <Typography component="li" variant="body1">El derecho de acceso.</Typography>
              <Typography component="li" variant="body1">El derecho a la rectificación.</Typography>
              <Typography component="li" variant="body1">El derecho a borrar.</Typography>
              <Typography component="li" variant="body1">El derecho a restringir el procesamiento.</Typography>
              <Typography component="li" variant="body1">El derecho a la portabilidad de datos.</Typography>
              <Typography component="li" variant="body1">El derecho a oponerte.</Typography>
              <Typography component="li" variant="body1">Derechos en relación con la toma de decisiones automatizada y la elaboración de perfiles.</Typography>
            </ul>
            <Typography variant="body1" paragraph align="justify">
