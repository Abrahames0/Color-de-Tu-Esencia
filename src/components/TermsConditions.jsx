          ...
          <Box my={4}>
            ...
            <Paper style={{ padding: '20px', marginTop: '20px' }} elevation={3}>
              <Typography variant="body1" paragraph>
                ¡Bienvenido a Color de tu esencia!
              </Typography>
              ...
              <Typography variant="body1" paragraph>
                Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando Color de tu esencia si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.
              </Typography>
              ...
              <Typography variant="body1" paragraph>
                El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a Color de tu esencia, aceptaste utilizar las cookies necesarias.
              </Typography>
              ...
              <Typography variant="body1" paragraph>
                A menos que se indique lo contrario, Xonix Techology y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en Color de tu esencia. Todos los derechos de propiedad intelectual son reservados.
              </Typography>
              ...
              <Typography variant="body1" component="div">
                <ul>
                  <li>Copiar o volver a publicar material de Color de tu esencia</li>
                  <li>Vender, alquilar o sublicenciar material de Color de tu esencia</li>
                  <li>Reproducir, duplicar o copiar material de Color de tu esencia</li>
                  <li>Redistribuir contenido de Color de tu esencia</li>
                </ul>
              </Typography>
